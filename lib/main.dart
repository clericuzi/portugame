...
import 'package:portugameapp/pages/origemPage.dart';
import 'package:portugameapp/pages/pageTest.dart';
import 'package:portugameapp/pages/paisPage.dart';
import 'package:portugameapp/util/nav.dart';
...
class _MyHomePageState extends State<MyHomePage> {
            ...
            Row(
              ...
              children: <Widget>[
                _menuItem('Origem do\n Idioma', FontAwesomeIcons.buffer,
                    blueGradient, TirinhaPage()), // primeiro box peq
                _menuItem('Países que \n falam', FontAwesomeIcons.globe,
                    blueGradient, PaisPage()), // segundo box peq
                _menuItem('Novo Acordo\n PDF', FontAwesomeIcons.file,
                    blueGradient, PageTest()),
              ],
            ),
            SizedBox(height: 10),
            Row(
              ...
              children: <Widget>[
                _menuItem('Principais\n Alterações',
                    FontAwesomeIcons.exchangeAlt, blueGradient, PageTest()),
                _menuItem('QUIZ', FontAwesomeIcons.question, yellowGradient,
                    PageTest()),
                _menuItem('Entre em\n contato', FontAwesomeIcons.at,
                    blueGradient, PageTest()),
              ],
            ),
          ],
  ...
  _menuItem(String title, IconData iconData, LinearGradient gradient, page) {
    //*************************************************************
    //*************************************************************
    //*************************************************************
    //*************************************************************
  ...
  _introCard() {
    // ***formatação box grande cinza escuro
    return Container(
      ...
      child: Column(
        // ***gera texto dentro do box cinza
        mainAxisAlignment: MainAxisAlignment.start,
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          Text(
  ...
  _cabecalho() {
    // ***gera o título: App Letras  (ir p linha 54)
    return Column(
      mainAxisAlignment: MainAxisAlignment.start,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
